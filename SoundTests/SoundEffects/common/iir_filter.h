...
inline void IIR_LPF(double fc, double Q, double a[], double b[])
{
...
inline void IIR_HPF(double fc, double Q, double a[], double b[])
{
  fc = tan(M_PI * fc) / (2.0 * M_PI);
...
inline void IIR_BPF(double fc1, double fc2, double a[], double b[])
{
...
inline void IIR_BEF(double fc1, double fc2, double a[], double b[])
{
  fc1 = tan(M_PI * fc1) / (2.0 * M_PI);
  fc2 = tan(M_PI * fc2) / (2.0 * M_PI);
...
inline void IIR_resonator(double fc, double Q, double a[], double b[])
{
  fc = tan(M_PI * fc) / (2.0 * M_PI);
...
inline void IIR_notch(double fc, double Q, double a[], double b[])
{
  fc = tan(M_PI * fc) / (2.0 * M_PI);
...
inline void IIR_low_shelving(double fc, double Q, double g, double a[], double b[])
{
  fc = tan(M_PI * fc) / (2.0 * M_PI);
...
inline void IIR_high_shelving(double fc, double Q, double g, double a[], double b[])
{
  fc = tan(M_PI * fc) / (2.0 * M_PI);
...
inline void IIR_peaking(double fc, double Q, double g, double a[], double b[])
{
  fc = tan(M_PI * fc) / (2.0 * M_PI);
